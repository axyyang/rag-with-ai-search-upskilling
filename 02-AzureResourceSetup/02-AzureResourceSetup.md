...
2. Deploy an Azure AI Foundry project.
3. Deploy an Azure Storage Account (ADLS Gen2) with hierarchical namespace enabled
4. Deploy an Azure AI Search Service (if no networking requirements exist, you can choose "Basic" tier, else "Standard" Tier S1)
...
- Launch Azure AI Foundry portal (Toggle New Foundry UI)
- Go to "Build" on the nav bar and select "Models" from the left-hand menu
